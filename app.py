...
""")
st.latex(r"""
    \text{Net Risk Adjusted Reward} = \text{Income From Deal} - \text{Operating Costs} - \text{Expected Loss}
""")
st.latex(r"""
    \text{Risk Adjusted Capital} = \text{Loan Amount} \times \text{Unexpected Loss Capital Allocation Factor}
""")
st.latex(r"""
